...
var modificación_xq = function(a,b,c,d,e){
	if(window.doxy.array_xq==undefined){
		window.doxy.array_xq = {
			a:[],b:[],c:[],d:[],e:[]
		}	
	}
	window.doxy.array_xq.a.push(a)
	window.doxy.array_xq.b.push(b)
	window.doxy.array_xq.c.push(c)
	window.doxy.array_xq.d.push(d)
	window.doxy.array_xq.e.push(e)
}
...
function permanecer_mensajes(){
	window.permanecer = Function(
		"a","b","c","d","e",
		window.xq.toString()
		.replace("n.removeChild(fe(n))","")
		.replace("function xq(a,b,c,d,e){","")
		.slice(0,-1)
	)
	window.xq = window.permanecer
}
