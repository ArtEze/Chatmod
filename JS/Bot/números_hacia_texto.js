window.númeroHaciaLetras = function(x)
{
	var devuelve=""
	var i,j,k
	var y,z
	var veintiún
	var esVálido, miles, resto
	...
	var centenas=[0,"Cien",200,300,400,"Quinientos",600,"Sete",800,"Nove"]
	var millón=[0,"Mi","Bi","Tri","Cuatri","Quinti","Sexti","Septi","Octi","Noni"]
	...
	veintiún=function(z){
		...
		miles=window.númeroHaciaLetras(z%1000000)
	...
	while(restoCondición(resto)==true)
	{
		...
		restoLetra=window.númeroHaciaLetras(restoUnidad)
